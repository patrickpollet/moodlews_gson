...
public class ContactRecord  extends GsonObject {
    ...
    private net.patrickpollet.moodlews_gson.core.ProfileitemRecord[] profile;
     ...
     * @return profile
     */
    public net.patrickpollet.moodlews_gson.core.ProfileitemRecord[] getProfile() {
        return profile;
    }
     ...
     * @param profile
     */
    public void setProfile(net.patrickpollet.moodlews_gson.core.ProfileitemRecord[] profile) {
