...
public class GsonUtils {
	 ...
	 * @return
	 */
	public static Gsoneabilisable getObject(SoapObject response,
			Gsoneabilisable theClass) {
	 ...
	 * @return
	 */
	public static List<Gsoneabilisable> getList(SoapObject response,
			Gsoneabilisable theClass) {
		int recordsCount = response.getPropertyCount();
		List<Gsoneabilisable> rets = new ArrayList<Gsoneabilisable>();
	 ...
	 * @return
	 */
	public static Gsoneabilisable[] getArray(SoapObject response,
			Gsoneabilisable theClass) {
		int recordsCount = response.getPropertyCount();
		Gsoneabilisable[] rets = new Gsoneabilisable[recordsCount];
		for (int i = 0; i < recordsCount; i++) {
			SoapObject record = (SoapObject) response.getProperty(i);
